...
<html lang="en">
    ...
    function widget_postaction(data) {
        ...
        for (i = 0; i < ret.length; i++) {
            ...
            } else if (pair[0] == "ether_expand") {
                ajax_ether_expand = pair[1];
            } else if (pair[0] == "wisp_expand") {
                ajax_wisp_expand = pair[1];
            } else if (pair[0] == "usb_expand") {
                ajax_usb_expand = pair[1];
...
function plug_state() {
    ...
    $("#USB").parents('td').next('td').next('td').html(usb_connect_enable);
        ...
        function connect_status(name, connection) {
            if(connection == "1") {
                ...
                if(name == "Ethernet" && '<%nvg_attr_get("","plug_rule", "0", "ethernet");%>' == "1") {
                    ...
                    if(wan_status == "0") {
                        return '<span class="badge badge-important"><%lang("Disconnect");%></span>';
        ...
        {    
            ...
            sOut += '<label><input type="radio" value="1" name="ether_enable" id="ether_name" onclick="pop_pppoe()" <%nvg_attr_match("ether_enable", "cnnt_rule", "0", "proto", "pppoe", "checked"); %>/><span class="lbl">&nbsp;&nbsp;<%lang("PPPoE");%> : <%lang("If you have an exact username and password, choose this. ");%></span></label><br>';
            sOut += '<label><input type="radio" value="0" name="ether_enable" id="ether_name" onClick="pop_static()" <%nvg_attr_match("ether_enable", "cnnt_rule", "0", "proto", "static", "checked"); %>/><span class="lbl">&nbsp;&nbsp;<%lang("Static IP");%> : <%lang("If you already have an IP adddress, choose this.");%></span></label><br>';   
            sOut += '<label><input type="radio" value="2" name="ether_enable" id="ether_name" onclick="GetRadioValue(this.name)" <%nvg_attr_match("ether_enable", "cnnt_rule", "0", "proto", "dhcp", "checked"); %>/><span class="lbl">&nbsp;&nbsp;<%lang("DHCP");%> : <%lang("If you have no any information from your network provider, choose this. ");%> </span></label>';          
            sOut += '</div></div>';
            return sOut;
        }	
        ...
        var aData = DataTable.fnGetData( nTr );
        var sOut = '<div class="control-group"><label class="control-label"></label><div class="controls">';
        sOut = '<label><input type="radio" value="2" name="USB_enable" onclick="GetRadioValue(this.name)" <%nvg_attr_match("USB_enable", "cnnt_rule", "2", "proto", "iphone", "checked"); %> /><span class="lbl">&nbsp;&nbsp;<%lang("Apple iPhone");%> : <%lang("If you want internet tethering on iPhone, choose this.");%></span></label><br>';
        sOut += '<label ><input type="radio" value="1" name="USB_enable" onclick="GetRadioValue(this.name)" <%nvg_attr_match("USB_enable", "cnnt_rule", "2", "proto", "htc", "checked"); %> /><span class="lbl">&nbsp;&nbsp;<%lang("Android phone");%> : <%lang("If you want internet tethering on Android phone, choose this.");%></span></label><br>';
        sOut += '<label ><input type="radio" value="0" name="USB_enable" onclick="dongle_modal_trigger()" <%nvg_attr_match("USB_enable", "cnnt_rule", "2", "proto", "wwan", "checked"); %> /><span class="lbl">&nbsp;&nbsp;<%lang("3G/4G Mobile Internet");%> : <%lang("If you want internet tethering on 3G/4G dongle, choose this.");%></span></label>';   
        sOut += '</div></div>';
            return sOut;
        }	
        ...
        function GetGridData(){
            ...
            for (var i=0; i<cnnt_rule.length; i++ )  {
                ...
                /*if(i == 0) {
                    connect_data[1] = ajax_connect_status('Ethernet', ajax_ether_connect);         
                    connect_data[1] += ajax_plug('Ethernet');
                }
                if(i == 1) {
                    connect_data[1] = ajax_connect_status('WISP', ajax_wisp_connect);         
                    connect_data[1] += ajax_plug('WISP');
                }
                if(i == 2) {
                    connect_data[1] = ajax_connect_status('USB', ajax_usb_plug);         
                    connect_data[1] += ajax_plug('USB');
                }*/
    ...
    function valid_password() {
        if($("#wl0_apcli0_secmode").val() == "wep") {
            ...
            if ($("#wl0_apcli0_key").val() != $("#wl0_apcli0_keyc").val()){
                alert('<%lang("Confirmed password did not match Entered Password.  Please re-enter password");%>');
...
<!-- PAGE CONTENT BEGINS HERE -->
  ...
  <div class="row-fluid">
    		  <div class="span4">
    			<div class="widget-box">
    				<div class="widget-header" style="padding:0px;">
    					<h4 class="span12" style="text-align:center;"><%lang("Wired Internet");%></h4>
    				</div>
    				...
    				<div class="widget-body-inner">
    				 <div class="widget-main">  
                        <div class="center"> 
                            <p>&nbsp;</p>
                            <a href="#Ethernet"><span class="aximDarkOrange"><i class="icon-code-fork icon-8x"></i></span></a>
                            <p>&nbsp;</p>
            			    <p class="alert" style="text-align:justify; border: none; background-color: transparent;">
						        <%lang("For ADSL, VDSL, Cable Modem, and Static IP users.");%>
						    </p>
                        </div>
    				 </div>
    				 </div>
    			...
    			<div class="widget-box">
    				...
    				<div class="widget-body">
    				    <div class="widget-main">
                          <div class="center">
                            <p>&nbsp;</p>
                            <a href="#WISP"><span class="aximDarkOrange"><i class="icon-rss icon-8x"></i></span></a>
                            <p>&nbsp;</p>
                			<p class="alert" style="text-align:justify; border: none; background-color: transparent;">
    						   <%lang("For wireless and hotspots users.");%>
    						</p>    				
    					  </div> 
    			        </div>                      
    			    </div>
    		  ...
    		  <div class="span4">
    			<div class="widget-box">
    				<div class="widget-header" style="padding:0px;">
    					<h4 class="span12" style="text-align:center;"><%lang("USB Internet");%></h4>
    				</div>
    				<div class="widget-body">
    				 <div class="widget-main">
                      <div class="center"> 
                        <p>&nbsp;</p>
                        <a href="#USB"><span class="aximDarkOrange"><i class="icon-mobile-phone icon-8x"></i></span></a>  
                        <p>&nbsp;</p>
                        <p class="alert" style="text-align:justify; border: none; background-color: transparent;"><%lang("For smart phone and 3G/4G modem users.");%>
    				    </p>  				
