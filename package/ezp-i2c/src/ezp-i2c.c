...
#define SIZE_MB (unsigned long long)(1000)
#define SIZE_GB (unsigned long long)(SIZE_MB * 1000)
#define SIZE_TB (unsigned long long)(SIZE_GB * 1000)
#define USB_RULE_IDX 0
#define SD_RULE_IDX 1
#define INTER_RULE_IDX 2
#define FORMAT_SPACE_OUTPUT_STRING(__SPVAL__, __UNIT__, __OUTPUT_BUF__, __UNIT_TYPE__) {int sp_quant; sp_quant = (__SPVAL__ + (__UNIT__ / 20)) * 10 / __UNIT__; \
    __OUTPUT_BUF__[3] = sp_quant / 1000; \
    __OUTPUT_BUF__[4] = (sp_quant % 1000) / 100; \
    __OUTPUT_BUF__[5] = (sp_quant % 100) / 10; \
    __OUTPUT_BUF__[6] = (sp_quant % 10); \
