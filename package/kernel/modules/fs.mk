...
define KernelPackage/fs-mini_fo
  SUBMENU:=$(FS_MENU)
  TITLE:=mini_fo filesystem support
  KCONFIG:=CONFIG_MINI_FO
  FILES:=$(LINUX_DIR)/fs/mini_fo/mini_fo.$(LINUX_KMOD_SUFFIX)
#  AUTOLOAD:=$(call AutoLoad,30,mini_fo)
endef

define KernelPackage/fs-mini_fo/description
 Kernel module for mini_fo filesystem support
endef

$(eval $(call KernelPackage,fs-mini_fo))
...
define KernelPackage/nls-cp936/description
 Kernel module for NLS Codepage 936 
endef
...
define KernelPackage/nls-cp950
  SUBMENU:=$(FS_MENU)
  TITLE:=Codepage 950 
  KCONFIG:=CONFIG_NLS_CODEPAGE_950 (Traditional Chinese)
  FILES:=$(LINUX_DIR)/fs/nls/nls_cp950.$(LINUX_KMOD_SUFFIX)
...
define KernelPackage/nls-cp932
  ...
  FILES:=$(LINUX_DIR)/fs/nls/nls_cp932.$(LINUX_KMOD_SUFFIX)
...
define KernelPackage/nls-cp949
  SUBMENU:=$(FS_MENU)
  TITLE:=Codepage 949 (Korean) 
  KCONFIG:=CONFIG_NLS_CODEPAGE_949
  FILES:=$(LINUX_DIR)/fs/nls/nls_cp949.$(LINUX_KMOD_SUFFIX)
  AUTOLOAD:=$(call AutoLoad,25,nls_cp949)
$(call KernelPackage/nls/Depends)
endef


define KernelPackage/nls-cp949/description
 Kernel module for NLS Codepage 949 (Korean)
endef

$(eval $(call KernelPackage,nls-cp949))
