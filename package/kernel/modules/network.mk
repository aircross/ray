...
define KernelPackage/ppp-synctty
  ...
  AUTOLOAD:=$(call AutoLoad,32,ppp_synctty)
endef
...
define KernelPackage/ezp-nat
  SUBMENU:=$(NETWORK_SUPPORT_MENU)
  TITLE:=Turbo NAT support
  FILES:=$(LINUX_DIR)/net/netfilter/ezp-nat.$(LINUX_KMOD_SUFFIX)
endef
define KernelPackage/ezp-nat/description
 Kernel modules for TurboNAT support
endef
$(eval $(call KernelPackage,ezp-nat))
