...
{
    char    *source_file = NULL, *source_path = NULL, *full_path = NULL, *path_tmp = NULL;
    char    *full_download_path = NULL;
    INPUT	*tmp;
    int     compress = 0, source_total = 0, isfolder = 0, exist = 0, i, filetype=0;
    long long offset = 0;
...
{
    INPUT   *tmp=NULL;
    char    *source_file=NULL, *source_path=NULL, *full_path=NULL, *path=NULL, *path_tmp=NULL;
    char    *full_download_path=NULL, *ssid=NULL, *fid=NULL, *p=NULL, *filename=NULL, *format=NULL;
